...
run;
PROC PRINT DATA=COL_CONVERTED_IT; RUN;
...
if BOTTLE_BUDGET = 'Less than 5€' then var7 = 1; else if BOTTLE_BUDGET = '5€ to less than 15€' then var7= 2; 
		...
		else if BOTTLE_BUDGET= '45€ to less than 60€' then var7=5; else if BOTTLE_BUDGET= '60€ and more' then var7=6;  
		else if BOTTLE_BUDGET= 'Meno di 5€' then var7=1; else if BOTTLE_BUDGET= '5€ - medo di 15€'  then var7=2; 
		else if BOTTLE_BUDGET= '15€ - meno di 30€' then var7=3; else if BOTTLE_BUDGET= '30€ - meno di 45€' then var7=4; 
		else if BOTTLE_BUDGET= '45€ - meno di 60€' then var7=5; else if BOTTLE_BUDGET= '60€ o pi€' then var7=6; 
else var7= 0;
...
if BUYING_EXPERIENCE = 'Never' then var8 = 1; else if BUYING_EXPERIENCE = '1-2 times per month' then var8= 2; 
		...
		else if BUYING_EXPERIENCE = '7+ times per month' then var8= 5; 
		/*italian*/
		else if BUYING_EXPERIENCE = 'Mai' then var8= 1; 
		else if BUYING_EXPERIENCE ='1-2 times per mon' then var8= 2; 
		else if BUYING_EXPERIENCE ='3-4 times per mon' then var8= 3; else if BUYING_EXPERIENCE = '5-6 times per mon' then var8= 4;
		else if BUYING_EXPERIENCE = '7+ times per mont' then var8= 5;
		
if WINE_BOTTLES = /*'Meno di una bottiglia' then var9= 1; else if WINE_BOTTLES= '1-3 bottiglie' then var9=2; else if WINE_BOTTLES= '4-6 bottiglie' then var9=3;
				else if WINE_BOTTLES= '7-9 bottiglie' then var9=4; else if WINE_BOTTLES= '10-12 bottiglie' then var9=5;
				else if WINE_BOTTLES= '12+ bottiglie' then var9=6; */
				'Less than 1 bottle' then var9= 1; else if WINE_BOTTLES= '1-3 bottles' then var9=2; else if WINE_BOTTLES= '4-6 bottles' then var9=3;
				else if WINE_BOTTLES= '7-9 bottles' then var9=4; else if WINE_BOTTLES= '10-12 bottles' then var9=5;
				else if WINE_BOTTLES= '12+ bottles' then var9=6;
		else var9= 0;
